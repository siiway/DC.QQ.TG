...
if (Test-Path (Join-Path $scriptDir "publish")) {
...
} elseif (Test-Path (Join-Path $defaultInstallDir "publish")) {
    ...
    if (-not (Test-Path (Join-Path $installDir "publish"))) {
        Write-ColorOutput "Could not find publish directory in $installDir" "Red"
...
if (-not (Test-Path $publishDir)) {
    Write-ColorOutput "Creating publish directory: $publishDir" "Yellow"
